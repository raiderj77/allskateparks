  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', height: '430px', overflow: 'hidden' }}>
        <img
          src={`https://source.unsplash.com/1600x800/?${heroKeyword}&sig=${slug.length + 400}`}
              ...
              {related.map((loc, i) => (
                <Link key={loc.slug} href={`/${state}/${loc.slug}`} style={{ textDecoration: 'none' }}>
                  <article className="card">
                    <img src={`https://source.unsplash.com/800x400/?skatepark,skateboarding&sig=${i + 100}`} alt={loc.name} className="card-img" loading="lazy" width={800} height={400} />
